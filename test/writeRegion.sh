...
&& \
../bin/bam writeRegion --in testFilesLibBam/sortedBam.bam --out results/regionRead3.sam --readName "1:1011:F:255+17M15D20" --refName 1 --start 1010 --end 1011 2> results/regionRead3.txt \
&& diff results/regionRead3.sam expected/regionReadNone.sam && diff results/regionRead3.txt expected/regionRead3.txt \
&& \
../bin/bam writeRegion --in testFilesLibBam/sortedBam.bam --out results/regionRead4.sam --refName 1 --start 1010 --end 1011 2> results/regionRead4.txt \
&& diff results/regionRead4.sam expected/regionRead2.sam && diff results/regionRead4.txt expected/regionRead4.txt \
&& \
../bin/bam writeRegion --in testFilesLibBam/sortedBam.bam --out results/regionRead5.sam --refName 1 --start 1010 --end 1011 --withinReg 2> results/regionRead5.txt \
&& diff results/regionRead5.sam expected/regionReadNone.sam && diff results/regionRead5.txt expected/regionRead5.txt \
&& \
../bin/bam writeRegion --in testFilesLibBam/sortedBam.bam --out results/regionRead6.sam --refName 1 --start 1014 --end 1015 2> results/regionRead6.txt \
&& diff results/regionRead6.sam expected/regionRead2.sam && diff results/regionRead6.txt expected/regionRead6.txt \
&& \
../bin/bam writeRegion --in testFilesLibBam/sortedBam.bam --out results/regionRead7.sam --refName 1 --start 1014 --end 1015 --withinReg 2> results/regionRead7.txt \
