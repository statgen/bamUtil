...
../bin/bam clipOverlap --splitClip --readName --in testFiles/testClipOverlapSplitClipReadName.sam --out results/testClipOverlapSplitClipReadName.sam --storeOrig XC --noph 2> results/testClipOverlapSplitClipReadName.log
let "status |= $?"
diff results/testClipOverlapSplitClipReadName.sam expected/testClipOverlapSplitClipReadName.sam
let "status |= $?"
diff results/testClipOverlapSplitClipReadName.log expected/testClipOverlapReadName.log
let "status |= $?"

# TODO Update more for splitClip....
