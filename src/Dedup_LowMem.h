...
#ifndef __DE_DUP_LM_H
#define __DE_DUP_LM_H
...
/*---------------------------------------------------------------/
  ...
  /
  /---------------------------------------------------------------*/
class Dedup_LowMem : public DedupBase
{
public:
...
private:
    ...
    struct MateData
    {
        ...
        std::string readName;
        MateData()
            : sumBaseQual(0), recordIndex(0), readName() {}
    };
    ...
    typedef std::map< DupKey, FragData > FragmentMap;
    ...
    typedef std::multimap<uint64_t, MateData> MateMap;
    ...
    // Mark supplementary/secondary reads
    bool myAllReadNames;
    ...
    inline void handleNonDuplicate() {}
    inline void handleNonDuplicatePair() {}
