This directory includes a small example of how METAL can be used to joitly meta-analyze study results
with both SNP main effets and interaction effects. 
...
the metal.txt script. The last three columns representing the effect size of the interaction effet,
its standard error and the covariance between the main effect and interaction effect are simulated.
